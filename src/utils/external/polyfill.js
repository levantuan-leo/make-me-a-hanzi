...
(function e(t, n, r) {
...
})(
  {
    ...
    15: [
      ...
      { 28: 28, 31: 31, 32: 32, 39: 39, 5: 5, 54: 54, 70: 70, 83: 83, 9: 9 },
    ],
    16: [
      function (_dereq_, module, exports) {
        "use strict";
    ...
    76: [
      ...
      { 12: 12, 18: 18, 22: 22, 30: 30, 33: 33, 34: 34 },
    ],
    77: [
      function (_dereq_, module, exports) {
        var toInteger = _dereq_(78),
    ...
    86: [
      function (_dereq_, module, exports) {
        ...
        $def($def.S, "Object", {
          ...
          keys: ($.getKeys =
            $.getKeys || createGetKeys(keys1, keysLen1, false)),
        });
    ...
    91: [
      ...
      { 18: 18, 19: 19, 36: 36, 41: 41, 44: 44, 80: 80, 81: 81, 85: 85 },
    ],
    92: [
      function (_dereq_, module, exports) {
        "use strict";
    ...
    98: [
      function (_dereq_, module, exports) {
        ...
        $def(
          $def.S +
            $def.F * !($acosh && Math.floor($acosh(Number.MAX_VALUE)) == 710),
          "Math",
          {
        ...
        if (!useNative) {
          ...
          _dereq_(54)(P.prototype, {
            ...
            then: function then(onFulfilled, onRejected) {
              ...
              var promise = (react.P = new (speciesConstructor(this, P))(
                function (res, rej) {
                  react.res = res;
                  react.rej = rej;
                }
    ...
    141: [
      ...
      { 17: 17, 19: 19, 25: 25, 3: 3, 39: 39, 47: 47, 5: 5 },
    ],
    142: [
      function (_dereq_, module, exports) {
    ...
    153: [
      ...
      { 19: 19, 31: 31, 39: 39, 47: 47, 5: 5, 61: 61 },
    ],
    154: [
      function (_dereq_, module, exports) {
        var $ = _dereq_(47),
    ...
    163: [
      function (_dereq_, module, exports) {
        ...
        $def(
          $def.S + $def.F * (!!$fromCodePoint && $fromCodePoint.length != 1),
          "String",
          {
    ...
    170: [
      function (_dereq_, module, exports) {
        ...
        $JSON &&
          $def($def.S + $def.F * (!useNative || buggyJSON), "JSON", {
            stringify: $stringify,
          });
